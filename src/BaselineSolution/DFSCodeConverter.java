...
public class DFSCodeConverter {
    ...
    private static void dfsTraversal(HPListGraph<Integer, Integer> graph,
                                     int currentNode,
                                     Set<Integer> visited,
    ...
    public static ArrayList<SimpleDFSCode> convertResultList(ArrayList<SearchLatticeNode<Integer, Integer>> results) {
        ...
        for (SearchLatticeNode<Integer, Integer> node : results) {
            ...
            if (simpleDfsCode != null) {
                if (!simpleDfsCode.isEmpty()) {
                    ...
                    System.out.println("Successfully converted DFS code with " + simpleDfsCode.size() + " edges");
                } else {
