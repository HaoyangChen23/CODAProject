...
public class VF2Node {
  ...
  public ArrayList<VF2Edge> outEdges =
      new ArrayList<VF2Edge>(); // edges of which this node is the origin
  public ArrayList<VF2Edge> inEdges =
      new ArrayList<VF2Edge>(); // edges of which this node is the destination
