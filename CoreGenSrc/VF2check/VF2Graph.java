...
public class VF2Graph {
  ...
  int[][] adjacencyMatrix; // stores graph structure as adjacency matrix (-1: not adjacent, >=0: the
  // edge label)
  ...
  /**
   * Get the adjacency matrix Reconstruct it if it needs an update
   *
  ...
  public int[][] getAdjacencyMatrix() {
    ...
    if (this.adjacencyMatrixUpdateNeeded) {
      ...
      for (int j = 0; j < k; j++) this.adjacencyMatrix[i][j] = -1;
