...
public class Variable {
  ...
  public Variable(
      int ID,
      int label,
      HashMap<Integer, myNode> list,
      ArrayList<MyPair<Integer, Double>> cons,
      ArrayList<MyPair<Integer, Double>> consBy) {
    this.list = list;
    this.label = label;
    this.ID = ID;
    if (cons == null) distanceConstrainedWith = new ArrayList<MyPair<Integer, Double>>();
    else distanceConstrainedWith = cons;
    if (consBy == null) distanceConstrainedBy = new ArrayList<MyPair<Integer, Double>>();
    else distanceConstrainedBy = consBy;
  }
  ...
  public HashSet<Integer> getLabelsDistanceConstrainedWith() {
    if (labelDistanceConstrainedWith == null) {
      ...
      if (temp != null) labelDistanceConstrainedWith.addAll(temp);
    }
  ...
  public HashSet<Integer> getLabelsDistanceConstrainedBy() {
    if (labelDistanceConstrainedBy == null) {
      ...
      if (temp != null) labelDistanceConstrainedBy.addAll(temp);
    }
