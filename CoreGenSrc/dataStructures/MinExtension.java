...
public class MinExtension<NodeType, EdgeType> extends GSpanEdge<NodeType, EdgeType> {
  ...
  protected int compareTo(final MinExtension<NodeType, EdgeType> other) {
    if (this.getNodeB() == DFSCode.UNUSED && other.getNodeB() != DFSCode.UNUSED) {
      return 1;
    }
    if (other.getNodeB() == DFSCode.UNUSED && this.getNodeB() != DFSCode.UNUSED) {
      return -1;
    }
  ...
  protected MinExtension<NodeType, EdgeType> set(
      final int nodeA,
      final int nodeB,
      final int labelA,
      final int edgeLabel,
