 ...
 *
 * <p>It represents the head marker of a double linked ring list.
 *
...
public class MinExtensionSet<NodeType, EdgeType> extends MinExtension<NodeType, EdgeType> {
  ...
  /**
   * insert the given <code>extension</code> and all extensions that are connected with the given on
   * to the set
   *
   * @param ext
   * @return <code>true</code>, if correctly added
