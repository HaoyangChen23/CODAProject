 ...
 */
public class GSpanExtension<NodeType, EdgeType>
    implements Extension<NodeType, EdgeType>, Serializable {
  ...
  public boolean equals(final Object obj) {
    return obj instanceof GSpanExtension && compareTo((GSpanExtension) obj) == 0;
  }
  ...
  /**
   * stores this extension to the given <code>target</code> environment, if possible
   *
   * @param target
   */
  public void release() {
