...
public interface Node<NodeType, EdgeType> extends Generic<NodeType, EdgeType> {
  ...
  /**
   * @return an iterator over all connected edges (undirected, outgoing, and incoming)
   */
  public Iterator<Edge<NodeType, EdgeType>> edgeIterator();

  /**
   * @return the number of all connected edges (undirected, outgoing, and incomming)
   */
