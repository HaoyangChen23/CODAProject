 ...
 */
public interface HPMutableGraph<NodeType, EdgeType> extends HPGraph<NodeType, EdgeType> {

  /**
   * adds a new edge between the given nodes
   *
   * @param nodeAIdx the index of the nodeA
   * @param nodeBIdx the index of the nodeB
   * @param label the label of the new edge
   * @param direction the direction of the new edge (in respect to nodeA)
   * @return the index of the new edge
   */
  public int addEdgeIndex(int nodeAIdx, int nodeBIdx, EdgeType label, int direction);
  ...
  public int addNodeAndEdgeIndex(
      int nodeAIdx, NodeType nodeLabel, EdgeType edgeLabel, int direction);
