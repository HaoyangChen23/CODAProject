...
public class ComplexPattern {
  ...
  private ArrayList<Integer> depthFirstSearchUndirect(
      int i, ArrayList<Integer> scList, ArrayList<ArrayList<Integer>> allList) {
  ...
  public void depthFirstSearchUndirect(
      HashMap<Integer, int[]> degreeMap, HPListGraph<Integer, Double> qryGraph) {
    ...
    while (nodesList != null && nodesList.size() != 0) {
      ...
      while (it.hasNext()) {
        ...
        if (degree[0] == 0
            && degree[1] != 0) { // start from node that in-degree is 0 and out-degree is not 0
          if (Settings.print) {
  ...
  public void depthFirstSearch(HashMap<Integer, int[]> degreeMap) {
    ...
    while (nodesList != null && nodesList.size() != 0) {
      ...
      while (it.hasNext()) {
        ...
        if (degree[0] == 0 && degree[1] == 0) it.remove();
      }
    }
  }
