...
/**
 * This class defines the functionality of a mining step, that encapsulate the whole generation of
 * extensions
 *
 ...
 */
public abstract class GenerationStep<NodeType, EdgeType>
  ...
  public GenerationStep(final MiningStep<NodeType, EdgeType> next) {
    super(null);
    finalize =
        new GenerationPartialStep<NodeType, EdgeType>(next) {
          @Override
          public void call(
