...
/**
 * This interface encapsulates the functionality to extend one (or more) parent nodes to a set of
 * children
 *
...
public interface Extender<NodeType, EdgeType> extends Generic<NodeType, EdgeType> {
   ...
   * @throws UnsupportedOperationException if not supported for the corresponding algorithm
   */
  public Collection<SearchLatticeNode<NodeType, EdgeType>> getChildren(
      Collection<SearchLatticeNode<NodeType, EdgeType>> nodes) throws UnsupportedOperationException;
   ...
   */
  public Collection<SearchLatticeNode<NodeType, EdgeType>> getChildren(
      SearchLatticeNode<NodeType, EdgeType> node) throws UnsupportedOperationException;
}
