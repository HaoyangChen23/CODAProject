...
/**
 * Creates a mining chain according to the gSpan algorithm, extended by different options.
 *
 ...
 */
public class Algorithm<NodeType, EdgeType>
    implements AlgorithmInterface.Algorithm<NodeType, EdgeType>, Generic<NodeType, EdgeType> {
  ...
  /**
   * This class represents a Label that is used for the pseudo node required for unconnected
   * fragemtn search in gSpan
   *
   * @author Marc Woerlein (woerlein@informatik.uni-erlangen.de)
   */
  ...
  //	private transient/* final */Map<GSpanEdge<NodeType, EdgeType>, SimpleDFSCode<NodeType,
  // EdgeType>> initials;
  ...
  //	public void setInitials(Map<GSpanEdge<NodeType, EdgeType>, SimpleDFSCode<NodeType, EdgeType>>
  // initials)
  //	{
  ...
  public Extender<NodeType, EdgeType> PatExtMeta(
    ...
    // YES
    generationFirst =
        new OneEdgeExtension<NodeType, EdgeType>(
            generationFirst, oneEdgePatterns, maxDegreeMatrix, sortedNodeLabels, kGraph);
