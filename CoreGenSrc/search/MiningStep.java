...
public abstract class MiningStep<NodeType, EdgeType> implements Generic<NodeType, EdgeType> {
  ...
  /**
   * creates a new MiningStep, with will call the given <code>next</code> step during the search if
   * necessary
   *
   * @param next
   */
  ...
  /**
   * tells this step that it is to be used for the given <code>node</code> with the given <code>
   * extensions</code> this function has to call the next step, if necessary.
   *
   * @param node
   * @param extensions
   */
  ...
  /**
   * calls the next step for the given <code>node</code> with the given <code>extensions</code>
   *
   * @param node
   * @param extensions
   */
