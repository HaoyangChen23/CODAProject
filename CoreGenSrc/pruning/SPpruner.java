...
public class SPpruner 
{
	...
	public <EdgeType> void getPrunedLists(HashMap<Integer,HashMap<Integer,myNode>> nodesByLabel, Query qry)
	{
	...
	public <EdgeType> void getPrunedLists(Graph graph, Query qry,HashMap<Integer, HashSet<Integer>> nonCandidates)
	{
